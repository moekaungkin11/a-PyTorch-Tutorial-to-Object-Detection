...
class PredictionConvolutions(nn.Module):
    ...
    def forward(self, conv4_3_feats, conv7_feats, conv8_2_feats, conv9_2_feats, conv10_2_feats, conv11_2_feats):
        ...
        #me permute actually change the parameter and why permute is It is to make it easier to combine predictions from 
        # multiple layers.(author answer)
...
class SSD300(nn.Module):
    ...
    def __init__(self, n_classes):
        ...
        #me can initiate to any dim only need to set other dim to 0(mean it work either (1,1,38,1) or (1,1,1,38) )
        ...
        for k, fmap in enumerate(fmaps):
            for i in range(fmap_dims[fmap]):
                for j in range(fmap_dims[fmap]):
                    cx = (j + 0.5) / fmap_dims[fmap] #me(fmap_dims[fmap] is equal to f_k that is image_size/steps and I think 
